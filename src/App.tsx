...
import { ExpertReportScreen } from './features/investmentSurvey/screens/ExpertReportScreen';
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/mydata/investment-profile/report" element={<PhoneFrame><ExpertReportScreen /></PhoneFrame>} />
    </Routes>
  );
}
